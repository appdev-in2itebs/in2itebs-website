...
- **Ambient video (2026-09-15).** Stock clips supplied by the owner at the repository root (git-ignored). Hero carousel, one per slide: `entry video.mp4` (2560×1440, 24 fps, 35 s), `sap 1.mp4` (2560×1440, 60 fps, 8 s), `applications 2.mp4` (1280×720, 12.7 s), `enterprise platforms 3.mp4` (2560×1440, 9 s), `data and ai 4.mp4` (2560×1440, 15 s). Methods section: `156-135737598_medium.mp4` (1280×720, 12.4 s, defocused open-plan office; Pixabay ID 156). Partners section (16:40): `partners section video.mp4` (1280×720, 7.3 s), encoded as `partners-office-720` (0.47 MB) with a poster. Retired: `70345-534725150_medium.mp4` (Pixabay ID 70345), the first hero clip. **Source and licence for every clip to be confirmed by the owner** and recorded here. Encoded into `web/public/video/` with ffmpeg (H.264, no audio, `+faststart`, hero clips trimmed to their first 10 s, 60 fps capped at 30): `hero-entry` 1080/720 (0.78/0.33 MB), `hero-sap` (1.5/0.75 MB), `hero-applications` 720 only (0.82 MB, its source is 720p), `hero-platforms` (2.3/1.2 MB), `hero-data-ai` (3.4/1.7 MB), `methods-office-720` (0.25 MB), each with a poster JPEG from the first second.

- **People and testimonial imagery (2026-09-16).** Copied from the live in2itebs.com homepage at the owner's request: four leadership portraits (`web/public/leadership/`, resized to 480px from the live PNGs), five testimonial avatars (`web/public/testimonials/*.jpg`, 240px) and five video-testimony thumbnails (`web/public/testimonials/<youtube-id>.jpg`, 960px JPEG from the live PNG/JPG cards). Same provenance and consent status as on the live site; confirm with the owner before any reuse beyond the homepage.
