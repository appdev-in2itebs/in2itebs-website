    ...
    <section className="theme-on-brand relative flex min-h-[70vh] items-center overflow-hidden bg-brand py-32 text-on-brand md:py-40">
      ...
      <Container>
        <Reveal className="flex max-w-3xl flex-col gap-7">
          ...
          <h1 className="text-display font-bold leading-[1.03]">
            {accepted ? (
              <>
                Thank you. Your request has been <Accent>accepted</Accent>.
              </>
            ) : (
              <>
                Let’s start a <Accent>conversation</Accent>.
              </>
            )}
          </h1>
          <p className="max-w-measure text-lg leading-relaxed text-brand-muted md:text-xl">
            {accepted
              ? "Your request was accepted by our delivery service. Keep the reference below if you need to follow up."
              : "There is no recent enquiry confirmation in this browser. Visit Contact to send a request or reach us by email."}
          </p>
