  ...
  return (
    <article className="group flex h-full flex-col rounded-xl2 bg-white p-7 shadow-soft ring-1 ring-navy/5 transition-[transform,box-shadow] duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lift">
      <div className="flex flex-wrap gap-2">
        <span className="rounded-full bg-off-white px-3 py-1 text-xs font-medium text-navy/70">
          {study.industry}
        </span>
      ...
      <p className="mt-3 line-clamp-2 flex-1 text-[0.9rem] leading-relaxed text-grey-muted">
        {study.scenario}
      </p>
